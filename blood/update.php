...
$view=mysql_query("SELECT * FROM donar_list WHERE  d_national_id= '$d_national_id'");	
...
if(!$updt)
	{
		die('Could not get data : '.mysql_error());
				...
				$name= $updt['name'] ;
				$village=$updt['village'] ;					
				$post=$updt['post'] ;
				$upazilla= $updt['upazilla'] ;
				$district=$updt['district'] ;
				$d_national_id=$updt['d_national_id'] ;
				$contact=$updt['contact'] ;
				$email= $updt['email'] ;
				$blood_group=$updt['blood_group'] ;					
				$gender=$updt['gender'] ;
				$day= $updt['day'] ;
				$month=$updt['month'] ;
				$year=$updt['year'] ;
...
{	
	...
	mysql_query("UPDATE donar_list SET name ='$name', village='$village',post='$post',upazilla='$upazilla',district='$district',d_national_id='$d_national_id',contact='$contact',email ='$email', 			  blood_group='$blood_group',gender='$gender',day='$day',month='$month',year='$year' WHERE d_national_id = '$d_national_id'")
				or die(mysql_error()); 			
}
...
?>
   ...
   <form action="#" method="post">
		<p><p>Name</p><input name="name" type="text" size="35" value="<?php echo $name ?>"/></p>
		<p>Address</p>
		
		
		<p><input name="village" type="text" size="35" value="<?php echo $village ?>"/></p>
		<p><input name="post" type="text" size="35" value="<?php echo $post ?>"/></p>
		<p><input name="upazilla" type="text" size="35" value="<?php echo $upazilla ?>"/></p>
		<p><input name="district" type="text" size="35" value="<?php echo $district ?>"/></p>
		 <p><p>National ID/Student ID</p><input name="d_national_id" type="text" size="35" value="<?php echo $d_national_id ?>"/></p>
		<p><p>Contact No</p><input name="contact" type="text" size="35" value="<?php echo $contact ?>"/></p>
		<p><p>Email</p><input name="email" type="text" size="35" value="<?php echo $email ?>"/></p>
	...
	<input name="update" type="submit" value="update" style="color:#990000" />
