...
$sql="INSERT INTO donar_list(name,village,post,upazilla,district,d_national_id,contact,email,blood_group,gender,day,month,year)
VALUES('$_POST[name]', '$_POST[village]', '$_POST[post]', '$_POST[upazilla]', '$_POST[district]',  '$_POST[national_id]','$_POST[contact]', '$_POST[email]', '$_POST[blood_group]', '$_POST[gender]', '$_POST[day]', '$_POST[month]', '$_POST[year]')";	
