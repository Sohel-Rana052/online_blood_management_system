	...
	<div class="nav">
	  			 <ul>
						 <li><a href="index.html"><button>Home</button></a></li>
         				 <li><a href="#"><button>Donar List</button></a></li>
...
while($row=mysql_fetch_array($result))
	{
		echo "<tr>
				...
				<td>".$row["month"]."</td>
				<td>".$row["year"]."</td>
				<td> <a href='update.php?d_national_id=".$row['d_national_id']."'><button>Edit</button></a></td>
				<td> <a href='delete.php?d_national_id=".$row['d_national_id']."'><button>Delete</button></a></td>
			</tr>";
